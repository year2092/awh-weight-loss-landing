...
const DifferentiationSection = () => {
  return (
    <section id="why-us" className="bg-gradient-to-b from-white to-secondary py-16">
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-300 hover-scale">
